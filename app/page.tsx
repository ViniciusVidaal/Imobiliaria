...
export default function Home() {
  return <><Preloader/><Animations/><Header/><main>
    ...
    <section id="contato" className="contact"><div><span className="eyebrow">Atendimento {brand.shortName}</span><h2>Qual imóvel você <em>procura?</em></h2></div><button className="btn light">Falar com a {brand.shortName} <ArrowRight/></button></section>
  </main><footer><Logo/><div><MapPin/> {brand.location}</div><small>© 2026 {brand.name}</small></footer><Fabs/></>;
}
