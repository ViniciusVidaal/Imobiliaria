...
export function Fabs() {
  return <div className="fabs"><a className="fab whatsapp" href={whatsappUrl("Olá! Gostaria de falar com a equipe AL7 Imóveis.")} target="_blank" rel="noreferrer" aria-label="Falar pelo WhatsApp"><WhatsAppIcon /></a></div>;
}
